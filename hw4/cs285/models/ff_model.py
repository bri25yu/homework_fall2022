...
class FFModel(nn.Module, BaseModel):
    ...
    def _forward_using_statistics(self, obs, acs, data_statistics):
        """
        Convenience method for calling forward
        """
        return self(
    ...
    def get_prediction(self, obs, acs, data_statistics):
        ...
        # outputs.
        prediction = self._forward_using_statistics(obs, acs, data_statistics)
