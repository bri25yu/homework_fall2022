...
class RL_Trainer(object):
    ...
    def train_agent(self):
        ...
        for train_step in trange(self.params['num_agent_train_steps_per_iter']):
            ...
            self.logger.log_scalar(train_log["Training Loss"], "train_loss", train_step)
    ...
    def do_relabel_with_expert(self, expert_policy, paths):
        ...
        for path in paths:
            our_observation = path["observation"]
            expert_action = expert_policy.get_action(our_observation)
    ...
    def perform_logging(self, itr, paths, eval_policy, train_video_paths, training_logs):
        # If we have train_video_paths, log them
